...
const Welcomebanner = () => {
  const { user } = useUser();
  return (
    <div className="flex gap-2 sm:gap-4 items-center w-full bg-linear-to-r from-blue-500/10 to-gray-700/10 border border-blue-500/30 rounded-lg p-3 sm:p-4 mb-4 sm:mb-6 lg:mb-8">
      <DotLottieReact
